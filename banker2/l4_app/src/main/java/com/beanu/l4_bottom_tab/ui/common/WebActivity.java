...
import static com.beanu.l4_bottom_tab.R.id.webview;


public class WebActivity extends BaseSDActivity {
    ...
    public boolean setupToolBarRightButton1(View rightButton1) {
        ((ImageView) rightButton1).setImageResource(R.drawable.ic_net);
...
//        ((ImageView) rightButton).setImageResource(R.drawable.ic_net);
//
