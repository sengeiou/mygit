package com.beanu.l3_gensee.voddemo;
...
public class PlayActivity extends Activity implements GSDocView.OnDocViewEventListener,
		VODPlayer.OnVodPlayListener, OnClickListener, OnSeekBarChangeListener {
