...
import com.beanu.l3_gensee.adapter.UserListAdapter;
import com.beanu.l3_gensee.config.ConfigApp;
...
public class PlayerDemoActivity extends FragmentActivity implements
        OnPlayListener, View.OnClickListener, OnItemClickListener {
...
//				: HANDlER.CACHING_END);
    ...
    protected void dialog() {
        ...
        Builder builder = new Builder(PlayerDemoActivity.this);
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (dialog == null) {
                    ...
                    dialog = new Builder(PlayerDemoActivity.this).setMessage("").setPositiveButton("签到", new OnClickListener() {
