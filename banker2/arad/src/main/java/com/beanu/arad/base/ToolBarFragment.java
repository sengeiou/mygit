        ...
        if (getUserVisibleHint() && !isHidden()) {
            ...
            if (getParentFragment() == null && parent instanceof AppCompatActivity) {
                ...
                if (view != null) {
                    ...
                    mRightButton3 = view.findViewById(R.id.toolbar_right_btn3);
                    mRightButton4 = view.findViewById(R.id.toolbar_right_btn4);
                    mRightButton5 = view.findViewById(R.id.toolbar_right_btn5);
