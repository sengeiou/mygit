...
public class UpdateChecker extends Fragment {
    ...
    public void showNotification(String content, String apkUrl) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("arad_system", "系统提示", NotificationManager.IMPORTANCE_LOW);
            notificationManager.createNotificationChannel(channel);
            noti = new NotificationCompat.Builder(mContext, "arad_system")
                    .setTicker(getString(R.string.arad_newUpdateAvailable))
