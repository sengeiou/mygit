...
public class ExpressionResource extends AbsChatResource{
	...
	public static void initExpressionResource(Context context) {
		...
		//如果使用插件化打包 dynamic load apk  请注释掉下面这一行，直接使用activity context
...
//		items.add(new Item("【rose.up.png】", "【鲜花】",context.getResources().openRawResource(R.drawable.brow_xh), "rose.up.png"));
