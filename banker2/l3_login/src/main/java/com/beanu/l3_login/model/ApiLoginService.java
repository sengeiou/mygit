...
public interface ApiLoginService {
    ...
    @FormUrlEncoded
    @POST("login")
    Observable<HttpModel<User>> user_login(@Field("account") String account, @Field("password") String password, @Field("loginType") String loginType, @Field("token") String token, @Field("sex") int sex, @Field("icon") String icon, @Field("nickName") String nickName);
