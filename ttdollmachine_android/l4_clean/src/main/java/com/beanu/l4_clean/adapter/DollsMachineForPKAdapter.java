...
public class DollsMachineForPKAdapter extends BaseAdapter<Dolls, DollsMachineForPKAdapter.ViewHolder> {

    private int mSelectedPos = -1;//保存当前选中的position

    public DollsMachineForPKAdapter(Context context, List<Dolls> list) {
        super(context, list);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_dolls_machine_pk, parent, false));
    }
