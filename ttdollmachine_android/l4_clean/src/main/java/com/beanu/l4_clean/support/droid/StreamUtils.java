package com.beanu.l4_clean.support.droid;
...
//        return doRequest("POST", url);
        return "rtmp://pili-publish.lizs.info/kxssz/test_right";
    }
...
//        return doRequest("GET", url);
        return "rtmp://pili-live-rtmp.lizs.info/kxssz/lianmai_test";
    }
...
//        return doRequest("POST", url);
        return "QzdCUKE0lXmIJsvJ_yQJTeIsJYeK6liEdWAn9JuU:I3ivxeTXWC5w5kLeRAIuOS41MA8=:eyJyb29tX25hbWUiOiJ3YXdhX3Jvb20yIiwidXNlcl9pZCI6IjEiLCJwZXJtIjoidXNlciIsImV4cGlyZV9hdCI6MTc4NTYwMDAwMDAwMH0=";
    }
    ...
    public static String getTestUserId(Context context) {
        ...
        mUserId = AppHolder.getInstance().user.getId();
