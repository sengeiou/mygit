...
public class AppHolder implements Serializable, Cloneable {
    ...
    public void addSiteClass(List<SiteClass> list) {
        mSiteClassList.addAll(list);
        save();
    }
    ...
    public List<SiteClass> mSiteClassList;
