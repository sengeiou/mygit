...
public interface APICartService {
     ...
     */
    @GET("delAddress")
    Observable<HttpModel<String>> address_delete(@Query("addressId") String addressId);
     ...
     */
    @GET("setIsDefault")
    Observable<HttpModel<String>> address_default(@Query("addressId") String addressId);
