 ...
 * 选择收货地址 / 我的地址
 */
public class AddressChooseActivity extends BaseTTActivity<AddressPresenterImpl, AddressModelImpl> implements AddressContract.View, View.OnClickListener, AddressViewBinder.OnAddressListener {
