...
public class PlaceOrderActivityFragment extends ToolBarFragment<PlaceOrderPresenterImpl, PlaceOrderModelImpl> implements View.OnClickListener, PlaceOrderContract.View {
    ...
    private void refreshAddress(AddressItem address) {
        mTxtAddressUserName.setText(address.getLinkName());
        mTxtAddressUserPhone.setText(address.getLinkPhone());
        mTxtAddress.setText(address.getProvinceName() + address.getCityName() + address.getCountyName() + address.getAddress());
        mTxtAddress.setTag(address.getAddressId());
    }
